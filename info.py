...
BOT_TOKEN = environ.get('BOT_TOKEN', "6746522771:AAFVWYG-ao-6qwOx_oRDGyD3NIe-CsBzfA8")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '1001717761625') # request channel id ( make sure bot is admin )
